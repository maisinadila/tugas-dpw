              ...
              <div class="row">
                <div class="col-md-5">
                  <div class="detail-box">
                    ...
                    <p>
                      Menyediakan berbagai furniture untuk mengisi rumah tercinta anda.
                    </p>
                    <div class="btn-box">
                      <a href="" class="btn1">
                        Contact Us
                ...
                <div class="col-md-7">
                  <div class="img-box">
                    <img src="{{ url('public/tugasmai') }}/images/furniture-malang.png" alt="">
                  </div>
                </div>
              </div>
            </div>
  ...
  <section class="about_section layout_padding long_section">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div class="img-box">
            <img src="{{ url('public/tugasmai') }}/images/kursipantai.png" alt="">
          </div>
        </div>
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <p>
              Buka setiap hari mulai pukul 07.00-21.00 wib. 
            </p>
            <a href="">
              Read More
            </a>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-4 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="{{ url('public/tugasmai') }}/images/b1.jpg" alt="">
            </div>
            <div class="detail-box">
              <h5>
        ...
        <div class="col-md-6 col-lg-4 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="{{ url('public/tugasmai') }}/images/b2.jpg" alt="">
            </div>
            <div class="detail-box">
              <h5>
        ...
        <div class="col-md-6 col-lg-4 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="{{ url('public/tugasmai') }}/images/b3.jpg" alt="">
            </div>
            <div class="detail-box">
              <h5>
          ...
          <div class="carousel-item active">
            <div class="row">
              <div class="col-md-11 col-lg-10 mx-auto">
                <div class="box">
                  <div class="img-box">
                    <img src="{{ url('public/tugasmai') }}/images/client.jpg" alt="" />
                  </div>
                  <div class="detail-box">
                    <div class="name">
